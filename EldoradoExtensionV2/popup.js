...
function runEldoradoAutomation(rawText) {
  ...
  function injectHelperWidget(folderPath) {
    ...
    actionBtn.addEventListener("click", () => {
      ...
      actionBtn.innerText = "✅ Đã Copy! Bấm Ctrl + V trên hộp thoại";
      actionBtn.style.background = "#27ae60"; // Màu xanh lá

      // Tự hủy widget sau 6 giây
      setTimeout(() => {
  ...
  async function runAutoFillForm() {
    ...
    // Sinh đường dẫn và Tiêm Widget Nổi vào màn hình web
    const folderPath = `C:\\Users\\trada\\Desktop\\Desktop\\output\\${parsed.username}`;
